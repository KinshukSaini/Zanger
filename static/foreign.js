...
const documentPathMap = {
  ...
  contract_number: ["Foreign Trade Contract.CONTRACT_HEADER.contract_number"],
  ...
  subject_basis: ["Foreign Trade Contract.1. Subject of the Contract.content.basis"],
  subject_details: ["Foreign Trade Contract.1. Subject of the Contract.content.details"],
