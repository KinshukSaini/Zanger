...
// Enhanced questionnaire for Memorandum of Association (Limited by Guarantee)
const documentQuestions = {
  step1: {
    ...
    companyName: {
      ...
      type: "text",
      placeholder: "e.g., Community Development Solutions Limited"
    },
    companyDesignation: {
...
/**
 * Enhanced document to HTML conversion for legal memorandum formatting (Limited by Guarantee)
 */
function convertToHtml(document) {
  ...
  function processSection(key, value, level, path) {
    ...
    if (key === "DOCUMENT_HEADER") {
      ...
      html.push(`
        <hr style="width: 80%; margin: 20px auto; margin-top: 30vh">
        <div class="document-header" data-path="${currentPath}" style="text-align: center; margin-bottom: 30px;">
      ...
      // Main content paragraph - specific for Limited by Guarantee
      html.push(`
...
/**
 * Enhanced form data to document mapping for memorandum (Limited by Guarantee)
 */
...
function downloadWordDocx() {
  ...
  const html = `
    ...
    <head>
      <meta charset="utf-8">
      <title>Memorandum of Association (Limited by Guarantee)</title>
      <style>
        body {
  ...
  link.href = url;
  link.download = "Memorandum_of_Association_Limited_by_Guarantee.docx";
